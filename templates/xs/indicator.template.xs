{*
    xs-core-engine indicator template
    C1-C5 must stay byte-identical to the trading template.
*}
...
begin
    Print(File(TxtPath), "engine=xs-core-engine,layer=indicator,mode=spec-first");
    headerWritten = true;
end;
...
Plot1(desiredPosition, "TargetPos");
Plot2(prevDayClose, "PrevDayClose");
Plot3(atrFrozen, "AtrFrozen");
